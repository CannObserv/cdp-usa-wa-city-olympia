...
1.  Create a GitHub Personal Access Token.
    ...
    -   Give the token a descriptive name / note. We recommend: `cdp-usa-wa-city-olympia-kkug`
...
1.  Attach the Google Service Account JSON as GitHub Repository Secret.
    ...
    -   Set the value to: the contents of the file `.keys/cdp-usa-wa-city-olympia-kkug.json`
    -   Click "Add secret"
...
1.  Build the basic project infrastructure.
    ...
    ```bash
    just setup cdp-usa-wa-city-olympia-kkug us-west1
    ```

1.  Initialize Firebase Storage.

    [Firestore Storage Page](https://console.firebase.google.com/u/0/project/cdp-usa-wa-city-olympia-kkug/storage)
